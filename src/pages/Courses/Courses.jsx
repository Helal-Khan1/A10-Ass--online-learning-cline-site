...
const Courses = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-200 py-10">
      <h1 className="font-bold text-4xl md:text-6xl text-center text-gray-800 mb-8">
        Explore the World’s Best Courses 🌎
      </h1>

      {/* 🧭 Category Filter Section */}
      {/* help in ai with chat gpt and jus filter section */}
      <div className="flex flex-wrap justify-center gap-3 mb-10 w-11/12 mx-auto">
          ...
          <button
            ...
            className={`px-5 py-2 rounded-full border font-semibold transition-all duration-300 ${
              selectedCategory === category
                ? "bg-[#00a598] text-white border-[#00a598]"
                : "bg-white text-gray-700 border-gray-300 hover:bg-[#00a598]/10"
            }`}
          >
            {category}
          </button>
